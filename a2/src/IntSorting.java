...
//      final int[] input = { 4, 10, 3, 1, 9, 15,6 };
...
//https://www.codingeek.com/algorithms/binary-insertion-sort-explanation-and-implementation/
         //using java builtin method for binary search

//         int insPoint = Math.abs(Arrays.binarySearch(a, 0, i, elem)+1);

         int insPoint = binarySearch(a, elem, 0, i);




         System.arraycopy(a, insPoint, a, insPoint+1, i-insPoint);
  ...
  // https://tutorialspoint.dev/algorithm/sorting-algorithms/binary-insertion-sort
   // Using recursive approach to find index position
   // implementing the one written in c
